...
namespace WeaveBase
{
    public class WeaveP2Server : IWeaveTcpBase
    {
        ...
        Socket socketLisener = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
        ...
        public WeaveP2Server(string _loaclip)
        {
            loaclip = _loaclip;
        }
        ...
        public WeaveP2Server(WeaveDataTypeEnum weaveDataType)
        {
